...
namespace EscapeRoomReviews.Repositories
{
    public class MockRepository
    {
        ...
        public MockRepository()
        {
            ...
            foreach (var room in _escapeRooms)
            {
        ...
        public List<EscapeRoom> GetAllRooms() => _escapeRooms;
        ...
        public List<Location> GetAllLocations() => _locations;
        
        public List<Company> GetAllCompanies() => _companies;
        
        public List<Theme> GetAllThemes() => _themes;
    }
}
